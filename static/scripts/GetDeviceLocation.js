async function GetDeviceLocation(workflowCtx, portal) {
  return {
    "Step 1": {
      name: "List Device Locations Synchronous",
...
This step retrieves the locations for a list of devices.`,
          endpointPermalink: "$e/Devices%20Locations/ListDevicesLocationsSynchronous",
