async function GetExperienceScore(workflowCtx, portal) {
    return {
      "Step 1": {
        name: "Get Experience Score",
...
This step is to run a report to view the device experience score over the last 30 days for a specific device.`,
            endpointPermalink: "$e/Wireless%20Network%20Performance/DeviceExperience30daysHistory",
