async function FotaUpgrade(workflowCtx, portal) {
    return {
      "Step 1": {
        name: "Fota Upgrade",
...
This step schedules a firmware upgrade for devices.`,
            endpointPermalink: "$e/Firmware%20V1/ScheduleFirmwareUpgrade",
