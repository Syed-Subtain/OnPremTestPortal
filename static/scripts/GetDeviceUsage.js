async function GetDeviceUsage(workflowCtx, portal) {
  return {
    "Step 1": {
      name: "Usage report aggregate",
...
In This step the information is returned in a callback response, so you must register a URL for DeviceUsage callback messages using the POST /callbacks API.`,
          endpointPermalink: "$e/Device%20Management/RetrieveAggregateDeviceUsageHistory",
