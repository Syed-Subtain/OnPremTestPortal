async function RegisterForOutages(workflowCtx, portal) {
    return {
      "Step 1": {
        name: "Register For Outages",
...
This step allows an application to register for callback notifications during a relevant network outage.`,
            endpointPermalink: "$e/Anomaly%20Triggers/CreateAnomalyDetectionTrigger",
