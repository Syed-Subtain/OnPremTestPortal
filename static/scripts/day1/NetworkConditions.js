async function NetworkConditions(workflowCtx, portal) {
    return {
      "Step 1": {
...
This step is to run a report to determine current network condition and availability. This status is updated multiple times per hour.`,
            endpointPermalink: "$e/Wireless%20Network%20Performance/NearRealTimeNetworkConditions",
